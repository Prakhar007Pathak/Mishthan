	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
				<div class="logo">
					<a href="index.php">
						<img src="my_img/temp_logo.jpg" alt="logo">
					</a>
				</div>
			</div>
			<!--========== /.Logo Section ===========-->
			...
			<div class="col-xs-12 col-sm-12 top-search-holder ">
				...
				<!-- ===========TOP CATEGORY========= -->
				<div class="spaceForCategories" id="spaceCategoriesId">
					<div class="categories" id="id-of-categories">
						<nav>
							<ul><a href="#">Our Product</a></ul>
							<ul><a href="brandList.html">Favourite Brands</a></ul>
							<ul><a href="brandPage.html">Box Customization</a></ul>
							<ul><a href="#">Our Gifts</a></ul>
							<ul><a href="#">About</a></ul>
							<!-- <ul><a href="benderPage.html">Help & Support</a></ul> -->
						</nav>
					</div>
					<button id="CatSearchBtn"><i class="bx bx-search" id="search-icon"></i></button>
				</div>
				<!-- ==========/.TOP CATEGORY========== -->
				...
				<div class="search-area" style="display: none">
					...
					<button id="CatBackBtn"><img src="my_img/back-arrow.png" alt="Back" width="22px" height="22px"></button>
				</div>
				<!-- =============/.top-search-holder =============-->
			</div>
			...
			<script>
				document.getElementById("CatSearchBtn").addEventListener("click", function() {
					document.getElementById("spaceCategoriesId").style.display = "none";
				...
				document.getElementById("CatBackBtn").addEventListener("click", function() {
					document.getElementById("spaceCategoriesId").style.display = "block";
					document.getElementById("CatSearchBtn").style.display = "block";
