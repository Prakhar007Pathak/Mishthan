...
<head>
	...
	<link rel="stylesheet" href="my_css/my-cart.css">
		...
		<div class="container">
			<div class="row inner-bottom-sm">
				<div class="shopping-cart">
					...
					<div class="forCartDisplay">
						<div class="col-md-4 col-sm-12 estimate-ship-tax">
							<table class="edditedTable table table-bordered">
								<thead>
									<tr>
										<th>
						...
						<div class="col-md-4 col-sm-12 cart-shopping-total">
							<table class="grandTotalTable table table-bordered">
								<thead>
									<tr>
										<th>
			...
			<!-- this brand slider is hidden -->
			<!-- <?php echo include('includes/brands-slider.ph'); ?> -->
			<!-- this brand slider is hidden -->
		</div>
	</div>
