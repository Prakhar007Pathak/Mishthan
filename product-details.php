...
<head>
	...
	<link rel="stylesheet" href="my_css/product-details.css">
	...
	<link rel="stylesheet" href="my_css/tiltCard&Button.css">
...
<body class="cnt-home">
	...
	<!-- ============================================== NAVBAR ============================================== -->
	<!-- <?php include('includes/menu-bar.ph'); ?> --> <!-- this navbaar is hidden -->
	<!-- ============================================== NAVBAR : END ============================================== -->

	<!-- ============================================== HEADER : END ============================================== -->
	<div class="breadcrumbb forHideDisplay">
		<div class="container">
	...
	<div class="body-content outer-top-xs">
		<div class='container'>
			<div class='row single-product outer-bottom-sm '>
				<div class='col-md-3 sidebar forHideDisplay'>
					<div class="sidebar-module-container">
						<!-- ==============================================CATEGORY============================================== -->
						<div class="sidebar-widget outer-bottom-xs wow fadeInUp forHideDisplay">
				...
				?>
					...
					<div class='col-md-9 forWidth'>
						<div class="row  wow fadeInUp">
							...
							<div class='col-sm-6 col-md-7 product-info-block'>
								<div class="product-info" style="height: auto;">
											...
											<div class="col-sm-6" style="width: 45%;">
												<div class="favorite-button m-t-10">
													<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist">
														<i class="heartColor fa fa-heart"></i>
													</a>
									...
									<div class="addToCart_buyButton">
										<div class="addToCartBtn">
											<div class="btn-31" style="padding: 8px 20px;">
												<?php if ($row['productAvailability'] == 'In Stock') { ?>
													<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary text-container"><i class="fa fa-shopping-cart inner-right-vs text" style="display: inline-block; color: #ff8700;"></i>
														<p style="display: inline-block; margin: 0; color: #000;">ADD TO CART</p>
													</a>
												<?php } else { ?>
													<div class="action" style="color:red">Out of Stock</div>
												<?php } ?>
										...
										<div class="BuyBtn">
											<div class="btn-31" style="padding: 8px 20px;">
												<span class="btn btn-primary text-container">
													<i class="fa fa-purchase inner-right-vs text"></i>
													BUY
												</span>
											</div>
										</div>
									...
									<div class="product-social-link m-t-20 text-right forHideDisplay">
						...
						<div class="product-tabs inner-bottom-xs  wow fadeInUp widthContainer">
							<div class="row">
								<div class="col-sm-3">
	...
	<!-- ============================================== UPSELL PRODUCTS ============================================== -->
	<section class="section featured-product wow fadeInUp widthContainer">
					...
					<div class="products">
						<div class="product">
							<div class="product-image">
								<div class="image">
									<a href="product-details.php?pid=<?php echo htmlentities($rw['id']); ?>"><img class="productImage" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['id']); ?>/<?php echo htmlentities($rw['productImage1']); ?>" width="150" height="240" alt=""></a>
								</div><!-- /.image -->
	...
	<script>
		function adjustHeight() {
			const elements = document.querySelectorAll('#owl-single-product .owl-wrapper-outer .owl-item');
